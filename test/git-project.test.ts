...
describe("Git project identity", () => {
  ...
  it("parses supported Git config syntax with linear final-assignment semantics", () => {
    ...
    for (const config of [
      ...
      "[extensions\t\"ignored\"]worktreeConfig = false\n[extensions]worktreeConfig = true\n",
      "[extensions \t  \"ignored\"]worktreeConfig = false\n[extensions]worktreeConfig = true\n",
      "[core\t\"ignored\"]worktree = ../wrong\n[extensions]worktreeConfig = true\n",
    ...
    for (const config of [
      ...
      `[extensions ]\nworktreeConfig = true\n[core]\nworktree = ${checkout}\n`,
      `[extensions\t]worktreeConfig = true\n[core]worktree = ${checkout}\n`,
      `[core\"sub\"]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
      `[core .sub]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
      `[core\t.sub]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
      `[core.sub ]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
      `[extensions.sub\t]worktreeConfig = true\n[core]worktree = ${checkout}\n`,
      `[core \"sub\" ]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
      `[extensions\t\"sub\"\t]worktreeConfig = true\n[core]worktree = ${checkout}\n`,
      `[core ][core]worktree = ${checkout}\n[extensions]worktreeConfig = true\n`,
