...
describe("versioned migration artifacts", () => {
  ...
  it("validates identity, state, metadata, coverage, project, source, and snapshot fields", () => {
    ...
    const invalid: Array<[unknown, string]> = [
      [null, "identity"],
      [{ ...good, version: 2 }, "identity"],
      [{ ...good, generationId: "bad" }, "identity"],
      [{ ...good, direction: "postgresql-to-sqlite" }, "state"],
      [{ ...good, sourceBackend: "postgresql" }, "state"],
      [{ ...good, destinationBackend: "sqlite" }, "state"],
      [{ ...good, status: "unknown" }, "state"],
      [{ ...good, createdAt: "bad" }, "metadata"],
      [{ ...good, updatedAt: "bad" }, "metadata"],
      [{ ...good, batchSize: 0 }, "metadata"],
      [{ ...good, sampleSize: 0 }, "metadata"],
      [{ ...good, schemaManifestSha256: "bad" }, "metadata"],
      [{ ...good, coverage: null }, "coverage"],
      [{ ...good, projects: [] }, "coverage"],
      [{ ...good, protocol: null }, "coverage"],
      [{ ...good, projects: [null] }, "project state"],
      [{ ...good, projects: [{ ...good.projects[0], identity: null }] }, "project state"],
      [{ ...good, projects: [{ ...good.projects[0], identity: { ...good.projects[0]!.identity, localProjectId: "bad" } }] }, "project state"],
      [{ ...good, projects: [{ ...good.projects[0], tables: null }] }, "project state"],
      [{ ...good, projects: [{ ...good.projects[0], operationalEvidence: null }] }, "project state"],
      [{ ...good, projects: [{ ...good.projects[0], sourceFingerprint: {} }] }, "source fingerprint"],
      [{ ...good, projects: [{ ...good.projects[0], sourceFingerprint: { main: fileFingerprint(), wal: {}, schemaSha256: digest } }] }, "source fingerprint"],
      [{ ...good, projects: [{ ...good.projects[0], snapshot: {} }] }, "snapshot"],
    ];
    for (const [value, reason] of invalid) expect(() => validateMigrationManifest(value), reason).toThrow(`invalid migration ${reason}`);
