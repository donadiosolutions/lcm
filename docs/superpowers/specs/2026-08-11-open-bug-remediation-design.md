...
#600 through #605. During canonical verification, #606 was discovered and
filed under the repository's mandatory bug-triage rule. Completion requires
each bug to have root-cause evidence, a
...
2. `fix/601-605-test-determinism` — #601, #605, and verification-discovered #606.
...
## PR 2: Full-Suite Test Determinism (#601, #605, #606)
...
3. Confirm #600 through #606 are closed with merged-PR evidence.
