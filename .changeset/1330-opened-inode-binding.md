...
the authenticated inode. LCM now retains the admitted database leaf and its
parent directory across the open and refuses when either one records a change,
before it adjusts permissions, initializes pragmas, or pools the connection.
