...
the closing quote in an unmatched bracket. Redact backslash paths in an exact file URL's
own query or fragment while that file-URL context remains active.
